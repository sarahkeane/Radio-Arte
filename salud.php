<?php include("header.php"); ?>
	...
	<div class="firstmenu" class="clearfix">
		<ul>
			<li><a href="/get-involved.php">Overview</a></li>
			<li><a href="/training.php">Training</a></li>
			<li><a href="/salud.php">Salud</a></li>
			<li class="last"><a href="/resources.php">Resources</a></li>
		</ul>
	</div>
	</div>
	...
	<div id="content" class="clearfix">
		...
		<div id="main">
			<div class="padding_left">
				<h1>SALUD: Healing Through the Arts</h1>
				...
				<h2>Radio Arte SALUD Workshops</h2>
				<h3>Health, Mind and Body</h3>
				...
				<p>
					...
					that addresses the central themes of our radio novelas (which you can hear on <a href="http://www.myspace.com/wrtechicago" target="blank">our myspace page</a>). 
				...
				<p>
					...
					work on a CD.  All works will be featured on 90.5 WRTE-FM’, <a href="http://www.myspace.com/wrtechicago" target="blank">Radio Arte's Myspace Page</a>, 
					and the <a href="http://www.newroutes.org/" target="blank">New Routes to Community Health initiative website</a>.
				</p>
				
				<h3>Hormones Gone Wild: Salud, mente y cuerpo (Health, mind & body)</h3>
				<p>
				...
				<h3>Immigration: Past and present</h3>
				<p>
				...
				<h3>Keeping a Healthy Mind: Stress reduction</h3>
				<p>
