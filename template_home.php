...
<div id="content" class="clearfix">
	...
	<div id="main" class="full-width">
	  ...
	  <div id="homepage-marquee">
	    <img src="images/header_homepage.jpg" width="760" height="362" alt="Header Homepage">
	    <h3>Blue Bar Title</h3>
	  </div>
		...
		<ul class="clearfix">
		  <li>
		    <a href="<!--"><img src="images/production_HomoFrecuencia.jpg" width="245" height="165" alt="Homo Frecuencia"></a>
		    <h3 class="homo-frecuencia">Homo Frecuencia</h3>
		   <a href="#">Read more</a>
		  </li>
		  
		  <li>
		    <a href="<!--"><img src="images/production_FirstVoice.jpg" width="245" height="165" alt="First Voice"></a>
		    <h3 class="first-voice">First Voice</h3>
		    <a href="#">Read more</a>
		  </li>
		  
		  <li class="last">
		   <a href="<!--"> <img src="images/production_PrimeraVoz.jpg" width="245" height="165" alt="Primera Voz"></a>
		    <h3 class="primera-voz">Primera Voz</h3>
		     <a href="#">Read more</a>
		  </li>
		  
		  <li>
		   <a href="<!--"> <img src="images/production_SinPapeles.jpg" width="245" height="165" alt="Sin Papeles"></a>
		    <h3 class="sin-papeles">Sin Papeles</h3>
		     <a href="#">Read more</a>
		  </li>
		  
		  <li>
		    <a href="<!--"><img src="images/production_WithoutBorders.jpg" width="245" height="165" alt="Without Borders"></a>
		    <h3 class="without-borders">Without Borders</h3>
		     <a href="#">Read more</a>
		  </li>
		  
		  <li class="last">
		    <a href="#"><img src="images/production_1401.jpg" width="245" height="165" alt="1401"></a>
		    <h3 class="without-borders">Without Borders</h3>
		    <a href="#">Read more</a>
		  </li>
